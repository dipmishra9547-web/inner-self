...
export function DarkSideQuizPage() {
  ...
  const handleAnswer = useCallback(
    async (idx: number) => {
      if (isSaving) return;
      const chosenType = question.options[idx].darkType;
      ...
      <div className="relative z-10 w-full max-w-lg">
        ...
        <div className="mb-6">
          <ProgressBar
            current={currentQ}
            total={totalQ}
            data-ocid="dark_side_quiz.progress_bar"
          />
        </div>
            ...
            >
              ...
              {isSaving ? (
                ...
                <>
                  ...
                  <div className="flex flex-col gap-2.5" data-ocid="dark_side_quiz.options_list">
